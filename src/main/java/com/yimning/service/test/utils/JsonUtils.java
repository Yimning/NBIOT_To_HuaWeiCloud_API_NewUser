...
public class JsonUtils {
    ...
    public static void main(String[] args) {
        ...
        String json = FileUtils.readToString(new File(
                "src" + File.separator + "main" + File.separator + "resources" + File.separator + "JsonString.json"), "UTF-8");
        parseJson2Java(json);
    }
    ...
    public static void parseJson2Java(String jsonStr) {
        ...
        FileUtils.writeString2File(javaBeanStr, new File(
                "src" + File.separator + "main" + File.separator + "java" + File.separator + "com" + File.separator + "yimning" + File.separator + "entity" + File.separator + "deviceMessage" + File.separator + "Message.java"));
    }
